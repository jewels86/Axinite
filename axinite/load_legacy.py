...
def load_legacy(delta: u.Quantity, limit: u.Quantity, bodies: ax.Body, t: u.Quantity = 0 * u.s, modifier = None, action=lambda *args, **kwargs: None):
    while t < limit:
        for body in bodies: 
            ...
            if modifier: f += modifier(body, t, bodies=bodies, f=f)
        ...
        t += delta
        action(t, limit=limit, bodies=bodies, delta=delta, modifier=modifier)
